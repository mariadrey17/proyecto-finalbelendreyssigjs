...
function notificacionFinal( ){
   ...
   console.log (impresionTituloExamen)
    ...
    function conseguirDatos () {
        fetch ("https://raw.githubusercontent.com/mariadrey17/pruebajson/main/subject.json ")
        .then (resp=>resp.json ())
...
for (const pass of estudiantesPass){
  ...
  const ciclo = ["Actuación teatral 2"  , "Historia del teatro3","Analisis de Texto 1", "Teatro contemporaneo"  ,"Histori de la danza contemporanea 3","Expresión corporal 2","Rítmica 2","Lenguaje Musical"  ]
...
//promesas
  const verMaterias2023 =(materiasInscribirse)=>{
    ...
    function verCupo(materiasAIngreso){
      ...
      document.getElementById("resultadoInscripcion").innerHTML="  estás  anotado :  " + registroInscripcion;
